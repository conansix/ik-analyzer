...
//		}
    ...
    public void testChinese() {
        ...
        testStr.add("据路透社报道，印度尼西亚社会事务部一官员星期二(29日)表示，日惹市附近当地时间27日晨5时53分发生的里氏6.2级" +
                "地震已经造成至少5427人死亡，20000余人受伤，近20万人无家可归。");
        testStr.add("公路局正在治理解放大道路面积水问题");
        testStr.add("福建省邮政储蓄局华林储蓄所");
        testStr.add("一九九五年12月31日,我在夜色下舞蹈 细长的鞋跟踩着星星的碎片 旋转的黑色裙摆覆盖来时的眼泪 亲爱的恋人 献给你" +
                "我最华丽的落幕");
        testStr.add("直接从 Gmail 内部与您的朋友们聊天，再也无需单独加载程序或查找新地址。只需点击一下鼠标，即可与通过电子邮件" +
                "来往的人以及 Google Talk 网络中的人聊天。现在您甚至可以保存和搜索 Gmail 帐户中的聊天记录。聊天还是不错的。");
        ...
        testStr.add("，联合国安理会16日(当地时间)对于涉及核武及导弹项目的5名朝鲜人士，确定了禁止旅行和冻结海外资产等制裁，并决" +
                "定同时制裁5个相关企业和2种相关材料。由此，对朝制裁首次包括朝鲜政府人士。另外，继4月冻结朝鲜3家企业的海外资产之" +
                "后，再加上上述5家企业，被安理会制裁的朝鲜企业合计共为8 家。在此之前的制裁名单里包括朝鲜外交官等共15人，但安理会" +
                "最终只确定了5人。对此，联合国的某外交官表示:“对个人的制裁具有象征性的意义。”“制裁名单被缩减为5人，可以理解为与" +
                "会国之间经过协调所达成的结果。安理会制裁的决定还包括5个企业，这些企业被怀疑与弹道导弹、核武器和其他大规模杀伤性" +
                "武器项目有关。与此同时，可用于制作导弹的EDM碳素化合物和芳纶(aramid)纤维，也被列为被制裁对象。");
        testStr.add("我真不知道台湾的媒体人是哪只眼睛看蔡英文是「小龙女」。蔡英文怎么会是小龙女。如果说原著的文字无法形象化小龙" +
                "女的形象，那么我们就从影视中来探究探究。许多影视剧中都有小龙女的扮演，台湾人比较熟悉早期陈玉莲，潘迎紫，新加坡有" +
                "范文芳，大陆的有刘亦菲，而其中最为经典的还属香港的李若彤，即便以最低标准的吴倩莲来说，以上诸位蔡英文能比哪一个？" +
                "千万不要亵渎了影迷们心目中的小龙女的光辉形象。");
